  ...
  <div>
    <el-container style="height: 100vh; border: 1px solid #eee">
      <el-header style="text-align: right; font-size: 12px">
        <div class="back" @click="$router.push('/home')">返回</div>
        <el-dropdown>
        ...
        <el-aside width="240px" style="background-color: rgb(238, 241, 246)">
          <el-menu :router="true" :default-active="menuActive">
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                <el-menu-item index="/announcements">通知提醒</el-menu-item>
                <el-menu-item index="/proceed">代办事项</el-menu-item>
                <el-menu-item index="/myapply">我的发起</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            <el-submenu index="2">
              <template slot="title">
