  ...
  <div class="form-box">
    ...
    >
      <div class="form-align3">
        ...
        <el-form-item label="职称类别" prop="name">
          <el-select v-model="formData.countryBirth" placeholder="请选择职称类别" class="form-sel">
            <el-option
        ...
        <el-form-item label="职称级别" prop="name">
          <el-select v-model="formData.countryBirth" placeholder="请选择职称级别" class="form-sel">
            <el-option
              v-for="item in sexList"
              :key="item.value"
              :label="item.label"
