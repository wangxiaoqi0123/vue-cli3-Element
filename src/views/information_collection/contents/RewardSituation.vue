<template>
  <div class="form-box">
    <div class="form-tips-title">
      <p>说明：请您填写过往获得过公司级别或市级以上奖励，学生时代获得的奖项不需要填写。</p>
    </div>
    <el-form
      :model="formData"
      :rules="rules"
    ...
    >
      <div class="form-align3">
        ...
        <el-form-item label="奖励级别" prop="name">
          <el-select v-model="formData.countryBirth" placeholder="请选择奖励级别" class="form-sel">
            <el-option
        ...
        <el-form-item label="是否团体奖" prop="name">
          <el-select v-model="formData.countryBirth" placeholder="请选择是否团体奖" class="form-sel">
            <el-option
              v-for="item in sexList"
              :key="item.value"
              :label="item.label"
